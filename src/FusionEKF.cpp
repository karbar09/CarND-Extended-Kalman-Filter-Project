...
FusionEKF::FusionEKF() {
  ...
  Hj_ = MatrixXd(3, 4); // Jacobian of Measurement Matrix
  ekf_.F_ = MatrixXd(4,4); // Initial transition matrix
...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  // Set values in State Transition Matrix according to the new elapsed time
  ekf_.F_(0,2) = dt;
  ekf_.F_(1,3) = dt;
